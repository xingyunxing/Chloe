...
namespace Chloe
{
    internal class DbSessionImpl : IDbSessionFacade
    {
        DbContextFacade _dbContext;

        public DbSessionImpl(DbContextFacade dbContext)
        {
        ...
        public IDbContextFacade DbContext { get { return this._dbContext; } }
