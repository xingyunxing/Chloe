...
namespace Chloe.KingbaseES
{
    partial class SqlGenerator : SqlGeneratorBase
    {
        ...
        {
            //EXTRACT(DAYS FROM (timestamp '2022-01-01 00:00:00' - timestamp '2021-01-01 00:00:00'))
            generator.SqlBuilder.Append("EXTRACT(");
            generator.SqlBuilder.Append(interval);
            generator.SqlBuilder.Append(" FROM (");
